...
func (o UserEvent) GetCursor(k pagination.Key) pagination.Cursor {
	if k == "id" {
...
func (o UserEvent) GetPaginationKeys() pagination.KeyTypes {
...
// NewUserEventPaginatorFromOptions generates a paginator for a UserEvent
func NewUserEventPaginatorFromOptions(
	options ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType UserEvent
...
// NewUserEventPaginatorFromQuery generates a paginator for a UserEvent
func NewUserEventPaginatorFromQuery(
...
// NewUserEventPaginatorFromRequest generates a paginator and cursor maker for a UserEvent
func NewUserEventPaginatorFromRequest(
	r *http.Request,
	defaultOptions ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType UserEvent
