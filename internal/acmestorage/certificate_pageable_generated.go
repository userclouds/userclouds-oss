...
func (o Certificate) GetCursor(k pagination.Key) pagination.Cursor {
	if k == "id" {
...
func (o Certificate) GetPaginationKeys() pagination.KeyTypes {
	keyTypes := pagination.KeyTypes{}
	keyTypes["id"] = pagination.UUIDKeyType
	return keyTypes
}

// NewCertificatePaginatorFromOptions generates a paginator for a Certificate
func NewCertificatePaginatorFromOptions(
	options ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType Certificate
...
// NewCertificatePaginatorFromQuery generates a paginator for a Certificate
func NewCertificatePaginatorFromQuery(
...
// NewCertificatePaginatorFromRequest generates a paginator and cursor maker for a Certificate
func NewCertificatePaginatorFromRequest(
	r *http.Request,
	defaultOptions ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType Certificate
