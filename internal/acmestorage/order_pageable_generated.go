...
func (o Order) GetCursor(k pagination.Key) pagination.Cursor {
	if k == "id" {
...
func (o Order) GetPaginationKeys() pagination.KeyTypes {
	keyTypes := pagination.KeyTypes{}
	keyTypes["id"] = pagination.UUIDKeyType
	return keyTypes
}

// NewOrderPaginatorFromOptions generates a paginator for a Order
func NewOrderPaginatorFromOptions(
	options ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType Order
...
// NewOrderPaginatorFromQuery generates a paginator for a Order
func NewOrderPaginatorFromQuery(
...
// NewOrderPaginatorFromRequest generates a paginator and cursor maker for a Order
func NewOrderPaginatorFromRequest(
	r *http.Request,
	defaultOptions ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType Order
