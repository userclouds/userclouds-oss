...
func (o TenantInternal) GetCursor(k pagination.Key) pagination.Cursor {
	if k == "id" {
...
func (o TenantInternal) GetPaginationKeys() pagination.KeyTypes {
	keyTypes := pagination.KeyTypes{}
	keyTypes["id"] = pagination.UUIDKeyType
	return keyTypes
}

// NewTenantInternalPaginatorFromOptions generates a paginator for a TenantInternal
func NewTenantInternalPaginatorFromOptions(
	options ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType TenantInternal
...
// NewTenantInternalPaginatorFromQuery generates a paginator for a TenantInternal
func NewTenantInternalPaginatorFromQuery(
...
// NewTenantInternalPaginatorFromRequest generates a paginator and cursor maker for a TenantInternal
func NewTenantInternalPaginatorFromRequest(
	r *http.Request,
	defaultOptions ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType TenantInternal
