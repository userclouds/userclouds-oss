...
func (o InviteKey) GetCursor(k pagination.Key) pagination.Cursor {
	if k == "id" {
...
func (o InviteKey) GetPaginationKeys() pagination.KeyTypes {
...
// NewInviteKeyPaginatorFromOptions generates a paginator for a InviteKey
func NewInviteKeyPaginatorFromOptions(
	options ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType InviteKey
...
// NewInviteKeyPaginatorFromQuery generates a paginator for a InviteKey
func NewInviteKeyPaginatorFromQuery(
...
// NewInviteKeyPaginatorFromRequest generates a paginator and cursor maker for a InviteKey
func NewInviteKeyPaginatorFromRequest(
	r *http.Request,
	defaultOptions ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType InviteKey
