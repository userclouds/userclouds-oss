...
func (o TenantURL) GetCursor(k pagination.Key) pagination.Cursor {
	if k == "id" {
...
func (o TenantURL) GetPaginationKeys() pagination.KeyTypes {
	keyTypes := pagination.KeyTypes{}
	keyTypes["id"] = pagination.UUIDKeyType
	return keyTypes
}

// NewTenantURLPaginatorFromOptions generates a paginator for a TenantURL
func NewTenantURLPaginatorFromOptions(
	options ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType TenantURL
...
// NewTenantURLPaginatorFromQuery generates a paginator for a TenantURL
func NewTenantURLPaginatorFromQuery(
...
// NewTenantURLPaginatorFromRequest generates a paginator and cursor maker for a TenantURL
func NewTenantURLPaginatorFromRequest(
	r *http.Request,
	defaultOptions ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType TenantURL
