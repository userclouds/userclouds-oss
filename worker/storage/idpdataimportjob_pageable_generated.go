...
func (o IDPDataImportJob) GetCursor(k pagination.Key) pagination.Cursor {
	if k == "id" {
...
func (o IDPDataImportJob) GetPaginationKeys() pagination.KeyTypes {
	keyTypes := pagination.KeyTypes{}
	keyTypes["id"] = pagination.UUIDKeyType
	return keyTypes
}

// NewIDPDataImportJobPaginatorFromOptions generates a paginator for a IDPDataImportJob
func NewIDPDataImportJobPaginatorFromOptions(
	options ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType IDPDataImportJob
...
// NewIDPDataImportJobPaginatorFromQuery generates a paginator for a IDPDataImportJob
func NewIDPDataImportJobPaginatorFromQuery(
...
// NewIDPDataImportJobPaginatorFromRequest generates a paginator and cursor maker for a IDPDataImportJob
func NewIDPDataImportJobPaginatorFromRequest(
	r *http.Request,
	defaultOptions ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType IDPDataImportJob
