...
func (o PlexToken) GetCursor(k pagination.Key) pagination.Cursor {
	if k == "id" {
...
func (o PlexToken) GetPaginationKeys() pagination.KeyTypes {
...
// NewPlexTokenPaginatorFromOptions generates a paginator for a PlexToken
func NewPlexTokenPaginatorFromOptions(
	options ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType PlexToken
...
// NewPlexTokenPaginatorFromQuery generates a paginator for a PlexToken
func NewPlexTokenPaginatorFromQuery(
...
// NewPlexTokenPaginatorFromRequest generates a paginator and cursor maker for a PlexToken
func NewPlexTokenPaginatorFromRequest(
	r *http.Request,
	defaultOptions ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType PlexToken
