...
func (o OTPState) GetCursor(k pagination.Key) pagination.Cursor {
	if k == "id" {
...
func (o OTPState) GetPaginationKeys() pagination.KeyTypes {
	keyTypes := pagination.KeyTypes{}
	keyTypes["id"] = pagination.UUIDKeyType
	return keyTypes
}

// NewOTPStatePaginatorFromOptions generates a paginator for a OTPState
func NewOTPStatePaginatorFromOptions(
	options ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType OTPState
...
// NewOTPStatePaginatorFromQuery generates a paginator for a OTPState
func NewOTPStatePaginatorFromQuery(
...
// NewOTPStatePaginatorFromRequest generates a paginator and cursor maker for a OTPState
func NewOTPStatePaginatorFromRequest(
	r *http.Request,
	defaultOptions ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType OTPState
