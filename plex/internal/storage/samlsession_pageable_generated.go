...
func (o SAMLSession) GetCursor(k pagination.Key) pagination.Cursor {
	if k == "id" {
...
func (o SAMLSession) GetPaginationKeys() pagination.KeyTypes {
	keyTypes := pagination.KeyTypes{}
	keyTypes["id"] = pagination.UUIDKeyType
	return keyTypes
}

// NewSAMLSessionPaginatorFromOptions generates a paginator for a SAMLSession
func NewSAMLSessionPaginatorFromOptions(
	options ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType SAMLSession
...
// NewSAMLSessionPaginatorFromQuery generates a paginator for a SAMLSession
func NewSAMLSessionPaginatorFromQuery(
...
// NewSAMLSessionPaginatorFromRequest generates a paginator and cursor maker for a SAMLSession
func NewSAMLSessionPaginatorFromRequest(
	r *http.Request,
	defaultOptions ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType SAMLSession
