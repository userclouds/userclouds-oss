...
func (o DelegationInvite) GetCursor(k pagination.Key) pagination.Cursor {
	if k == "id" {
...
func (o DelegationInvite) GetPaginationKeys() pagination.KeyTypes {
	keyTypes := pagination.KeyTypes{}
	keyTypes["id"] = pagination.UUIDKeyType
	return keyTypes
}

// NewDelegationInvitePaginatorFromOptions generates a paginator for a DelegationInvite
func NewDelegationInvitePaginatorFromOptions(
	options ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType DelegationInvite
...
// NewDelegationInvitePaginatorFromQuery generates a paginator for a DelegationInvite
func NewDelegationInvitePaginatorFromQuery(
...
// NewDelegationInvitePaginatorFromRequest generates a paginator and cursor maker for a DelegationInvite
func NewDelegationInvitePaginatorFromRequest(
	r *http.Request,
	defaultOptions ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType DelegationInvite
