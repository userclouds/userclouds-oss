...
func (o Accessor) GetCursor(k pagination.Key) pagination.Cursor {
	if k == "id" {
...
func (o Accessor) GetPaginationKeys() pagination.KeyTypes {
...
// NewAccessorPaginatorFromOptions generates a paginator for a Accessor
func NewAccessorPaginatorFromOptions(
	options ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType Accessor
...
// NewAccessorPaginatorFromQuery generates a paginator for a Accessor
func NewAccessorPaginatorFromQuery(
...
// NewAccessorPaginatorFromRequest generates a paginator and cursor maker for a Accessor
func NewAccessorPaginatorFromRequest(
	r *http.Request,
	defaultOptions ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType Accessor
