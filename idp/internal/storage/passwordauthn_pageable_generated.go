...
func (o PasswordAuthn) GetCursor(k pagination.Key) pagination.Cursor {
	if k == "id" {
...
func (o PasswordAuthn) GetPaginationKeys() pagination.KeyTypes {
	keyTypes := pagination.KeyTypes{}
	keyTypes["id"] = pagination.UUIDKeyType
	return keyTypes
}

// NewPasswordAuthnPaginatorFromOptions generates a paginator for a PasswordAuthn
func NewPasswordAuthnPaginatorFromOptions(
	options ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType PasswordAuthn
...
// NewPasswordAuthnPaginatorFromQuery generates a paginator for a PasswordAuthn
func NewPasswordAuthnPaginatorFromQuery(
...
// NewPasswordAuthnPaginatorFromRequest generates a paginator and cursor maker for a PasswordAuthn
func NewPasswordAuthnPaginatorFromRequest(
	r *http.Request,
	defaultOptions ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType PasswordAuthn
