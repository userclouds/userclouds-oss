...
func (o ColumnValueRetentionDuration) GetCursor(k pagination.Key) pagination.Cursor {
	if k == "id" {
...
func (o ColumnValueRetentionDuration) GetPaginationKeys() pagination.KeyTypes {
...
// NewColumnValueRetentionDurationPaginatorFromOptions generates a paginator for a ColumnValueRetentionDuration
func NewColumnValueRetentionDurationPaginatorFromOptions(
	options ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType ColumnValueRetentionDuration
...
// NewColumnValueRetentionDurationPaginatorFromQuery generates a paginator for a ColumnValueRetentionDuration
func NewColumnValueRetentionDurationPaginatorFromQuery(
...
// NewColumnValueRetentionDurationPaginatorFromRequest generates a paginator and cursor maker for a ColumnValueRetentionDuration
func NewColumnValueRetentionDurationPaginatorFromRequest(
	r *http.Request,
	defaultOptions ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType ColumnValueRetentionDuration
