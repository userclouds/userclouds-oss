...
func (o OIDCAuthn) GetCursor(k pagination.Key) pagination.Cursor {
	if k == "id" {
...
func (o OIDCAuthn) GetPaginationKeys() pagination.KeyTypes {
	keyTypes := pagination.KeyTypes{}
	keyTypes["id"] = pagination.UUIDKeyType
	return keyTypes
}

// NewOIDCAuthnPaginatorFromOptions generates a paginator for a OIDCAuthn
func NewOIDCAuthnPaginatorFromOptions(
	options ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType OIDCAuthn
...
// NewOIDCAuthnPaginatorFromQuery generates a paginator for a OIDCAuthn
func NewOIDCAuthnPaginatorFromQuery(
...
// NewOIDCAuthnPaginatorFromRequest generates a paginator and cursor maker for a OIDCAuthn
func NewOIDCAuthnPaginatorFromRequest(
	r *http.Request,
	defaultOptions ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType OIDCAuthn
