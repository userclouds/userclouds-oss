...
func (o AccessorSearchIndex) GetCursor(k pagination.Key) pagination.Cursor {
	if k == "id" {
...
func (o AccessorSearchIndex) GetPaginationKeys() pagination.KeyTypes {
...
// NewAccessorSearchIndexPaginatorFromOptions generates a paginator for a AccessorSearchIndex
func NewAccessorSearchIndexPaginatorFromOptions(
	options ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType AccessorSearchIndex
...
// NewAccessorSearchIndexPaginatorFromQuery generates a paginator for a AccessorSearchIndex
func NewAccessorSearchIndexPaginatorFromQuery(
...
// NewAccessorSearchIndexPaginatorFromRequest generates a paginator and cursor maker for a AccessorSearchIndex
func NewAccessorSearchIndexPaginatorFromRequest(
	r *http.Request,
	defaultOptions ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType AccessorSearchIndex
