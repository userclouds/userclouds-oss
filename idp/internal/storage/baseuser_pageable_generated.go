...
func (o BaseUser) GetCursor(k pagination.Key) pagination.Cursor {
	if k == "id" {
...
func (o BaseUser) GetPaginationKeys() pagination.KeyTypes {
...
// NewBaseUserPaginatorFromOptions generates a paginator for a BaseUser
func NewBaseUserPaginatorFromOptions(
	options ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType BaseUser
...
// NewBaseUserPaginatorFromQuery generates a paginator for a BaseUser
func NewBaseUserPaginatorFromQuery(
...
// NewBaseUserPaginatorFromRequest generates a paginator and cursor maker for a BaseUser
func NewBaseUserPaginatorFromRequest(
	r *http.Request,
	defaultOptions ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType BaseUser
