...
func (o Purpose) GetCursor(k pagination.Key) pagination.Cursor {
	if k == "id" {
...
func (o Purpose) GetPaginationKeys() pagination.KeyTypes {
...
// NewPurposePaginatorFromOptions generates a paginator for a Purpose
func NewPurposePaginatorFromOptions(
	options ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType Purpose
...
// NewPurposePaginatorFromQuery generates a paginator for a Purpose
func NewPurposePaginatorFromQuery(
...
// NewPurposePaginatorFromRequest generates a paginator and cursor maker for a Purpose
func NewPurposePaginatorFromRequest(
	r *http.Request,
	defaultOptions ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType Purpose
