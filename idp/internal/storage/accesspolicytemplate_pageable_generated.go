...
func (o AccessPolicyTemplate) GetCursor(k pagination.Key) pagination.Cursor {
	if k == "id" {
...
func (o AccessPolicyTemplate) GetPaginationKeys() pagination.KeyTypes {
...
// NewAccessPolicyTemplatePaginatorFromOptions generates a paginator for a AccessPolicyTemplate
func NewAccessPolicyTemplatePaginatorFromOptions(
	options ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType AccessPolicyTemplate
...
// NewAccessPolicyTemplatePaginatorFromQuery generates a paginator for a AccessPolicyTemplate
func NewAccessPolicyTemplatePaginatorFromQuery(
...
// NewAccessPolicyTemplatePaginatorFromRequest generates a paginator and cursor maker for a AccessPolicyTemplate
func NewAccessPolicyTemplatePaginatorFromRequest(
	r *http.Request,
	defaultOptions ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType AccessPolicyTemplate
