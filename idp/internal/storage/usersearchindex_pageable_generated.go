...
func (o UserSearchIndex) GetCursor(k pagination.Key) pagination.Cursor {
	if k == "id" {
...
func (o UserSearchIndex) GetPaginationKeys() pagination.KeyTypes {
...
// NewUserSearchIndexPaginatorFromOptions generates a paginator for a UserSearchIndex
func NewUserSearchIndexPaginatorFromOptions(
	options ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType UserSearchIndex
...
// NewUserSearchIndexPaginatorFromQuery generates a paginator for a UserSearchIndex
func NewUserSearchIndexPaginatorFromQuery(
...
// NewUserSearchIndexPaginatorFromRequest generates a paginator and cursor maker for a UserSearchIndex
func NewUserSearchIndexPaginatorFromRequest(
	r *http.Request,
	defaultOptions ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType UserSearchIndex
