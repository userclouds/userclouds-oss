...
func (o MFARequest) GetCursor(k pagination.Key) pagination.Cursor {
	if k == "id" {
...
func (o MFARequest) GetPaginationKeys() pagination.KeyTypes {
	keyTypes := pagination.KeyTypes{}
	keyTypes["id"] = pagination.UUIDKeyType
	return keyTypes
}

// NewMFARequestPaginatorFromOptions generates a paginator for a MFARequest
func NewMFARequestPaginatorFromOptions(
	options ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType MFARequest
...
// NewMFARequestPaginatorFromQuery generates a paginator for a MFARequest
func NewMFARequestPaginatorFromQuery(
...
// NewMFARequestPaginatorFromRequest generates a paginator and cursor maker for a MFARequest
func NewMFARequestPaginatorFromRequest(
	r *http.Request,
	defaultOptions ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType MFARequest
