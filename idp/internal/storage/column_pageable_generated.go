...
func (o Column) GetCursor(k pagination.Key) pagination.Cursor {
	if k == "id" {
...
func (o Column) GetPaginationKeys() pagination.KeyTypes {
...
// NewColumnPaginatorFromOptions generates a paginator for a Column
func NewColumnPaginatorFromOptions(
	options ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType Column
...
// NewColumnPaginatorFromQuery generates a paginator for a Column
func NewColumnPaginatorFromQuery(
...
// NewColumnPaginatorFromRequest generates a paginator and cursor maker for a Column
func NewColumnPaginatorFromRequest(
	r *http.Request,
	defaultOptions ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType Column
