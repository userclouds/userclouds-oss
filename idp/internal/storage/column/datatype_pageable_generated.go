...
func (o DataType) GetCursor(k pagination.Key) pagination.Cursor {
	if k == "id" {
...
func (o DataType) GetPaginationKeys() pagination.KeyTypes {
...
// NewDataTypePaginatorFromOptions generates a paginator for a DataType
func NewDataTypePaginatorFromOptions(
...
// NewDataTypePaginatorFromQuery generates a paginator for a DataType
func NewDataTypePaginatorFromQuery(
...
// NewDataTypePaginatorFromRequest generates a paginator and cursor maker for a DataType
func NewDataTypePaginatorFromRequest(
	r *http.Request,
	defaultOptions ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType DataType
