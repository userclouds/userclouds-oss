...
func (o Secret) GetCursor(k pagination.Key) pagination.Cursor {
	if k == "id" {
...
func (o Secret) GetPaginationKeys() pagination.KeyTypes {
...
// NewSecretPaginatorFromOptions generates a paginator for a Secret
func NewSecretPaginatorFromOptions(
	options ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType Secret
...
// NewSecretPaginatorFromQuery generates a paginator for a Secret
func NewSecretPaginatorFromQuery(
...
// NewSecretPaginatorFromRequest generates a paginator and cursor maker for a Secret
func NewSecretPaginatorFromRequest(
	r *http.Request,
	defaultOptions ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType Secret
