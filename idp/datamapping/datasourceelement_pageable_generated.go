...
func (o DataSourceElement) GetCursor(k pagination.Key) pagination.Cursor {
	if k == "id" {
...
func (o DataSourceElement) GetPaginationKeys() pagination.KeyTypes {
...
// NewDataSourceElementPaginatorFromOptions generates a paginator for a DataSourceElement
func NewDataSourceElementPaginatorFromOptions(
	options ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType DataSourceElement
...
// NewDataSourceElementPaginatorFromQuery generates a paginator for a DataSourceElement
func NewDataSourceElementPaginatorFromQuery(
...
// NewDataSourceElementPaginatorFromRequest generates a paginator and cursor maker for a DataSourceElement
func NewDataSourceElementPaginatorFromRequest(
	r *http.Request,
	defaultOptions ...pagination.Option,
) (*pagination.Paginator, error) {
	var resultType DataSourceElement
